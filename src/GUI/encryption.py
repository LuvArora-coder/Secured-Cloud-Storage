...
def encrypt(fileName):
    Key = keyRead()
    with open("D://Cloud-Encryption//src//Files//"+ fileName, "rb") as f:
        data = f.read()
    fernet = Fernet(Key)
    encrypted = fernet.encrypt(data)
    with open("D://Cloud-Encryption//src//Files//"+ fileName, "wb") as f:
        f.write(encrypted)
...
def decrypt(fileName):
    Key = keyRead()
    with open("D://Cloud-Encryption//src//Downloads//"+ fileName, "rb") as f:
        data = f.read()
    fernet = Fernet(Key)
    decrypted = fernet.decrypt(data)
    with open("D://Cloud-Encryption//src//Downloads//"+ fileName, "wb") as f:
        f.write(decrypted)